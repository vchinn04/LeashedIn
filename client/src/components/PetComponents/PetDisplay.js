...
const EditButton = (props) => // Edit button
{
  if (!(props.isEditing)) return(
    <IconButton sx={{ position: 'absolute', mb: 0, ml: '0.25%', mt: '0.25%' }} centerRipple={false} size="large" aria-label="edit profile" onClick={() => {props.setEdit(true)}}>
      <EditIcon />
    </IconButton>
  )
}
      ...
      <div className="pet-display-frame">
        <Slide direction="down" in={true} mountOnEnter unmountOnExit>
          <div className="pet-info-frame">
            ...
            <IconButton className="pet-frame-close" centerRipple={false} sx={{ mb: 0, ml: '0.75%', mt: '0.1%' }} color="primary" aria-label="profile" size="xlarge" onClick={() => {props.setCurrentPet(null)}}>
